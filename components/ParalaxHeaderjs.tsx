    ...
    <div ref={divRef}>
      <section className="h-screen flex items-center justify-center bg-gray-200 overflow-hidden scroll-smooth">
        <Image
          ...
          width="1920"
          height="1080"
          className="object-cover w-full h-full bg-no-repeat object-center "
          priority
        />
        <ul className="absolute overflow-hidden flex items-center list-none h-screen text-5xl lg:text-9xl font-black text-white">
          <li
            className="scroll border-b-4 dark:border-white border-primary/90 text-white dark:text-primary/90"
            data-rate="-2"
            data-direction="vertical"
          >
            Cake
          </li>
          <li className="border-b-4 border-white dark:border-primary/90 dark:text-white text-primary/90">Alch</li>
          <li
            className="scroll border-b-4 dark:border-white border-primary/90 text-white dark:text-primary/90"
            data-rate="2"
            data-direction="vertical"
        ...
        <span
          className="scroll absolute w-20 lg:w-40 h-20 lg:h-40 bottom-4 left-4 overflow-hidden"
          data-ratey="-1.5"
          data-ratex="2"
        ...
        <h2 className="absolute bottom-6 sm:bottom-9 lg:bottom-[70px] left-28 lg:left-[250px] text-primary/80 text-2xl sm:text-4xl lg:text-5xl xl:text-7xl">Lorem ipsum dolor sit amet.</h2>
      </section>
