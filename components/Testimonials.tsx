...
export default function Testimonials() {
    ...
    return (
        <div className="flex flex-col items-center justify-center px-4">
            <p className="flex justify-center items-center font-bold px-6 py-3 border shadow-inner mr-4 rounded-2xl text-primary/80 dark:text-black dark:bg-white mb-8">Testimonials</p>
